...
add_fileset_file axi4lite_shim.sv SYSTEM_VERILOG PATH $env(WORKDIR)/ofs-common/src/common/lib/axi4lite/axi4lite_shim.sv TOP_LEVEL_FILE
...
add_interface_port altera_axi4lite_slave s_wstrb wstrb Input 8
...
add_interface_port altera_axi4lite_master m_wstrb wstrb Output 8
...
# 
# from altera_axi_bridge_hw.tcl
# 
add_parameter WRITE_ISSUING_CAPABILITY INTEGER 16 "Write Issuing Capability"
set_parameter_property WRITE_ISSUING_CAPABILITY DEFAULT_VALUE 1
...
set_parameter_property READ_ISSUING_CAPABILITY DEFAULT_VALUE 512
...
set_parameter_property COMBINED_ISSUING_CAPABILITY DEFAULT_VALUE 512
