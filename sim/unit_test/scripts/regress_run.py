...
def send_email_report():
    ...
    message["Subject"] = f"Unit Test Regression results for OFS AC - Tool:{args.simulator}"
...
def sim_farm_process(index, test, test_dir_top, simulator):
    ...
    if (os.path.exists(test_file)):
        ...
        if (simulator == 'vcs'):
            ...
            build_command_line  = f"arc submit -PE flow/sw/bigmem mem=20000 -- sh run_sim.sh VCSMX=1"
        else:
