***Test Description***
This is the unit test for HE_LPBK. The test uses HE-MEM to perform memory loopback between FIM and the host.

Description of test modules:
   * test_csr_defs.sv   - Defines HE-MEM CSR addresses. 
