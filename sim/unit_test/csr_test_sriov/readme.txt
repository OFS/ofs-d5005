***Test Description***
Following scenarios are covered in this test :
   * test_afu_mmio – covered illegal AFU MMIO access returning all 0s
   * test_mmio_addr32 – 32 bit Read/Write on FME and Port CSRs (includes access to unimplemented register space)
   * test_mmio_addr64 – 64 bit Read/Write on FME and Port CSRs (includes access to unimplemented register space)
   * test_vf2_flr_reset  – VF2 Reset Scenario  
   * test_vf1_flr_reset  – VF1 Reset Scenario  
   * test_vf0_flr_reset  – VF0 Reset Scenario  
   * test_pf0_flr_reset  – PF0 FLR reset scenario
