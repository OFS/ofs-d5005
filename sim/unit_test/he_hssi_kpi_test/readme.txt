***Test Description***
This is the unit test for HE_HSSI. The test uses HE-HSSI to perform tx loopback between HE-HSSI and HSSI-SS. The data path is data from He-HSSI -> HSSI SS -> tx pin -> looped back in tb -> rx pin -> HSSI SS -> HE-HSSI. After traffic flow, this test calculates latency and throughput values.

Description of test modules:
   * test_csr_defs.sv   - Defines HE-HSSI CSR addresses. 
