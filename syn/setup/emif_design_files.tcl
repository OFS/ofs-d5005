...
# EMIF IP
set_global_assignment -name IP_FILE $::env(BUILD_ROOT_REL)/ipss/mem/ip/emif_ddr4_no_ecc.ip
set_global_assignment -name IP_FILE $::env(BUILD_ROOT_REL)/ipss/mem/ip/avmm_cdc.ip
set_global_assignment -name IP_FILE $::env(BUILD_ROOT_REL)/ipss/mem/ip/avmm_pipeline_bridge.ip
