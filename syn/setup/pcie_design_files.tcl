...
# PCIE IP
#--------------------
set_global_assignment -name IP_FILE ../ip_lib/ipss/pcie/qip/pcie_ep_g3x16.ip
...
set_global_assignment -name SYSTEMVERILOG_FILE $::env(BUILD_ROOT_REL)/ipss/pcie/rtl/axis_lib/axis_register.sv
