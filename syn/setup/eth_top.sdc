...
# reset sync from pcie clk to hssi_clk
set_false_path -from $CLK250 -to {*|he_hssi_top_inst|GenRstSync[0].tx_reset_synchronizer|resync_chains[0].synchronizer|dreg[*]}  
set_false_path -from $CLK250 -to {*|he_hssi_top_inst|GenRstSync[0].rx_reset_synchronizer|resync_chains[0].synchronizer|dreg[*]}  
